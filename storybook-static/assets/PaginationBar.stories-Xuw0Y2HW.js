import{d as aa,e as y,w as ea,k as na,c as d,a as c,n as i,F as ta,D as ra,o as m,A as k}from"./vue.esm-bundler-DbAMlMm1.js";import{_ as ia}from"./_plugin-vue_export-helper-DlAUqK2U.js";function sa(){const a=(n,r)=>(n.indexOf(r)===-1&&n.push(r),!0);return{setPaginationItems:(n,r,e,g)=>{n.length=0,n.push("1"),r-g>2&&n.push("...");for(let s=-1*g;s<=g;s++)r+s>1&&r+s<e&&a(n,String(r+s));r+g<e-1&&n.push("..."),a(n,String(e))}}}const oa=["onClick"],ga=["onClick"],W=aa({__name:"PaginationBar",props:{maxPage:{},paddingSize:{}},emits:["change"],setup(a,{emit:b}){const n=a,r=n.paddingSize??1,e=y(1),g=y([]),s=b,{setPaginationItems:h}=sa(),v=t=>{e.value=t,s("change",e.value)},X=()=>{e.value=e.value>1?e.value-1:1,s("change",e.value)},Y=()=>{e.value=e.value<n.maxPage?e.value+1:n.maxPage,s("change",e.value)};return ea(e,()=>h(g.value,e.value,n.maxPage,r)),na(()=>h(g.value,e.value,n.maxPage,r)),(t,Sa)=>(m(),d("div",{class:i(t.$style.pagination_bar_container)},[c("nav",{class:i(t.$style.bar)},[c("ul",{class:i(t.$style.pagination_buttons)},[c("li",{class:i(t.$style.pagination_button)},[c("a",{onClick:X,class:i(t.$style.pagination_button_content)}," < ",2)],2),(m(!0),d(ta,null,ra(g.value,p=>(m(),d("li",{key:p,class:i(t.$style.pagination_button)},[p==="..."?(m(),d("a",{key:0,class:i(t.$style.pagination_button_content)}," ... ",2)):p===String(e.value)?(m(),d("a",{key:1,onClick:Z=>v(Number(p)),class:i(t.$style.selected_page_button)},k(p),11,oa)):(m(),d("a",{key:2,onClick:Z=>v(Number(p)),class:i(t.$style.pagination_button_content)},k(p),11,ga))],2))),128)),c("li",{class:i(t.$style.pagination_button)},[c("a",{onClick:Y,class:i(t.$style.pagination_button_content)}," > ",2)],2)],2)],2)],2))}}),pa="_pagination_bar_container_xlthk_2",da="_bar_xlthk_6",ca="_pagination_buttons_xlthk_12",ma="_pagination_button_xlthk_12",ua="_pagination_button_content_xlthk_27",la="_selected_page_button_xlthk_34",Pa={pagination_bar_container:pa,bar:da,pagination_buttons:ca,pagination_button:ma,pagination_button_content:ua,selected_page_button:la},xa={$style:Pa},o=ia(W,[["__cssModules",xa]]);W.__docgenInfo={exportName:"default",displayName:"PaginationBar",description:"",tags:{},props:[{name:"maxPage",required:!0,type:{name:"number"}},{name:"paddingSize",required:!1,type:{name:"number"}}],events:[{name:"change"}],sourceFiles:["/home/runner/work/vue3-template/vue3-template/app/src/components/organisms/PaginationBar/PaginationBar.vue"]};const Ba={title:"organisms/PaginationBar",component:o},u={args:{maxPage:12,paddingSize:1},render:a=>({components:{PaginationBar:o},setup(){return{...a}},template:'<PaginationBar :maxPage="maxPage" :paddingSize="paddingSize" />'})},l={args:{maxPage:12,paddingSize:2},render:a=>({components:{PaginationBar:o},setup(){return{...a}},template:'<PaginationBar :maxPage="maxPage" :paddingSize="paddingSize" />'})},P={args:{maxPage:1,paddingSize:1},render:a=>({components:{PaginationBar:o},setup(){return{...a}},template:'<PaginationBar :maxPage="maxPage" :paddingSize="paddingSize" />'})},x={args:{maxPage:2,paddingSize:1},render:a=>({components:{PaginationBar:o},setup(){return{...a}},template:'<PaginationBar :maxPage="maxPage" :paddingSize="paddingSize" />'})},S={args:{maxPage:2,paddingSize:2},render:a=>({components:{PaginationBar:o},setup(){return{...a}},template:'<PaginationBar :maxPage="maxPage" :paddingSize="paddingSize" />'})},_={args:{maxPage:3,paddingSize:1},render:a=>({components:{PaginationBar:o},setup(){return{...a}},template:'<PaginationBar :maxPage="maxPage" :paddingSize="paddingSize" />'})},z={args:{maxPage:4,paddingSize:1},render:a=>({components:{PaginationBar:o},setup(){return{...a}},template:'<PaginationBar :maxPage="maxPage" :paddingSize="paddingSize" />'})},B={args:{maxPage:4,paddingSize:2},render:a=>({components:{PaginationBar:o},setup(){return{...a}},template:'<PaginationBar :maxPage="maxPage" :paddingSize="paddingSize" />'})};var f,M,$;u.parameters={...u.parameters,docs:{...(f=u.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    maxPage: 12,
    paddingSize: 1
  },
...
}`,...(q=(N=P.parameters)==null?void 0:N.docs)==null?void 0:q.source}}};var E,O,A;x.parameters={...x.parameters,docs:{...(E=x.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    maxPage: 2,
    paddingSize: 1
  },
...
}`,...(A=(O=x.parameters)==null?void 0:O.docs)==null?void 0:A.source}}};var L,V,j;S.parameters={...S.parameters,docs:{...(L=S.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    maxPage: 2,
    paddingSize: 2
  },
...
}`,...(j=(V=S.parameters)==null?void 0:V.docs)==null?void 0:j.source}}};var G,H,I;_.parameters={..._.parameters,docs:{...(G=_.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    maxPage: 3,
    paddingSize: 1
  },
